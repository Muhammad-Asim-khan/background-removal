            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="name" defaultValue="Ak" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="email">Email</Label>
                  <Input id="email" type="email" defaultValue="ak@example.com" />
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              {[
                ...
                { title: "Processing Complete", desc: "Get notified when your images are ready" },
                { title: "Credit Alerts", desc: "Alert when credits are running low" },
                { title: "Product Updates", desc: "News about features and improvements" },
                { title: "Marketing Emails", desc: "Tips, offers, and newsletter" },
              ].map((item) => (
